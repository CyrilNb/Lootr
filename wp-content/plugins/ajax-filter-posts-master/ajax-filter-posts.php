...
class Ajax_Filter_Posts {
	...
	*/
	public function get_genre_filters($post_type, $taxo) {
	    ...
	    if( $terms ):
			...
			$filters_html .= '<span id="titre-filtre-publications">LOOTER PAR</span><span id="filtre-publications">';
	        ...
	        $filters_html .= '</span></div><div id="genre-results" class="row-eq-height no-gutters"></div>';
	...
	*/
	public function ajax_genre_filter()
	{
		...
		echo '<div class="titre-article-publications"><h2>Les Articles</h2></div>';
